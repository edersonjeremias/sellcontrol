...
export default function VendasPage() {
  ...
  const calcSacolas = useCallback((linhas) => {
    ...
    // ✅ IMPORTANTE: INCLUI linhas ENVIADAS para preservar o mapeamento cliente→sacolinha
    linhasOrdenadas.forEach(l => {
      if (l.deleted || !l.cliente_nome?.trim()) return  // Remove !l.isSent - precisa incluir enviadas
      ...
      // Se linha tem sacolinha válida do banco (INCLUI enviadas!)
  ...
  // ── SINCRONIZAR (Atualizar bloqueios de clientes) ──
  const sincronizar = useCallback(async () => {
    ...
    try {
      ...
      globalDBRef.current = db
      setGlobalDB(db)
      showToast('✅ Clientes bloqueados atualizados!', 'success')
    } catch (err) {
          ...
          <div className="toolbar">
            ...
            <div className="actions">
              ...
              <button className="btn-acao btn-ghost" onClick={sincronizar} disabled={busy}
                style={{ minWidth:44, padding:'0 10px' }} title="Sincronizar (Atualizar bloqueios de clientes)">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
