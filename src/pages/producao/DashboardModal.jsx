...
export default function DashboardModal({ rows, onClose }) {
  ...
  const chartOptions = {
    ...
    scales: {
      x: { ticks: { color: '#abb1bd' }, grid: { color: '#3c414b' } },
      y: { ticks: { color: '#abb1bd' }, grid: { color: '#3c414b' }, beginAtZero: true },
    },
  }
      ...
      <div className="prod-modal-card prod-dash-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 10, marginBottom: 20 }}>
          {[
            ...
            <div key={c.label} style={{ background: '#26292f', border: '1px solid #3c414b', borderRadius: 8, padding: '12px 8px', textAlign: 'center' }}>
              <div style={{ fontSize: 11, color: '#abb1bd', marginBottom: 4 }}>{c.label}</div>
        ...
        {chartData && (
          <div style={{ background: '#26292f', borderRadius: 8, padding: 16 }}>
