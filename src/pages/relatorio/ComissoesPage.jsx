    ...
    <AppShell title="Relatório de Comissões" hideTitle>
      ...
      <div className="p-4 print:p-0 print:bg-white" data-print-area>
        ...
        <div className="hidden print:block text-center mb-6 pb-4 border-b-2 border-gray-300">
          <h1 className="text-2xl font-bold mb-2 print:text-black print:!text-5xl">
            Relatório de Comissões{nomeEmpresa && ` - ${nomeEmpresa}`}
          </h1>
          <p className="text-base print:text-gray-600 print:!text-2xl">
        ...
        {dados.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full max-w-4xl mx-auto border-collapse text-sm
                           print:max-w-full print:text-black print:!text-xl">
              <thead>
                <tr className="border-b-2 print:border-gray-400" style={{ borderColor: 'var(--border-light)' }}>
                  <th className="px-2 py-2 text-center font-semibold text-xs
                               print:border print:border-gray-400 print:bg-gray-100 print:text-black print:!text-lg"
                    ...
                    <td className="px-2 py-2 text-center text-xs
                      ...
                      <input
                        ...
                        className="w-16 px-2 py-1 text-center text-xs rounded
                                 print:border-none print:bg-transparent print:w-auto print:p-0 print:appearance-none print:text-black print:!text-lg"
                        style={{
                        ...
                        step="0.1"
                      />
                      <span className="ml-1 print:!text-lg">%</span>
                    </td>
                    <td className="px-2 py-2 text-right text-xs font-bold
                                 print:border print:border-gray-400 print:text-black print:!text-lg"
